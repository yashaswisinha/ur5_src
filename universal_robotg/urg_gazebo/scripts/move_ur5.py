...
def main(data):
    ...
    global pose
    pub = rospy.Publisher('robot2/eff_joint_traj_controller/command',JointTrajectory,queue_size=1)
    pub1 = rospy.Publisher('/robot2/gazebo_ros_control/command', Float64, queue_size=10)
    ...
    Q0=np.array([sub[0], -sub[1], -sub[2]+1.8, 2.8+sub[2]+sub[1], -1.57, sub[5] ])
