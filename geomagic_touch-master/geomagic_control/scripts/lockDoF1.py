...
#         self.listener = tf.TransformListener()
        ...
        self.lock = 0.0
        self.sub = rospy.Subscriber("Geomagic/joint_states",JointState,self.callback, queue_size=1)
	...
	global elbow1
        waist = js.position[0]
        lift1 = -js.position[1]
	elbow1 = js.position[2]
        #pan = js.actual.positions[0]
        self.of.force.x = (pan-waist)*3
        self.of.force.y =  (lift1-lift)*4
	self.of.force.z =  (elbow1-elbow)*4
     #   self.of.force.y =0 
